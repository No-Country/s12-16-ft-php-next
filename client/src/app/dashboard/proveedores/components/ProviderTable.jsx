                    ...
                    <tbody className="divide-y divide-gray-200 ">
                        {
                            ...
                            filteredProviders.map((provider, index) => (
                                <tr key={index} className="hover:bg-gray-100">
                                    ...
                                    <td className="whitespace-nowrap p-3 text-sm">{provider.cuit}</td>
                                    <td className="whitespace-nowrap p-3 text-sm">{provider.direction}</td>
                                    <td className="whitespace-nowrap p-3 text-sm">{provider.location}</td>
                                    <td className="whitespace-nowrap p-3 text-sm">{provider.email}</td>
                                    <td className="whitespace-nowrap p-3 text-sm">{provider.tel}</td>
