...
import { MagnifyingGlassIcon, NewspaperIcon, WrenchIcon, ArrowPathIcon, ChartBarIcon, FolderPlusIcon } from '@heroicons/react/24/outline'
                ...
                links.map((link => {
                    ...
                    return (
                        <Link
                            ...
                            href={link.href}
                            className={clsx(
                                'flex h-[48px] grow items-center justify-center  text-txt-custom gap-2 rounded-md p-3 text-md font-medium hover:bg-sky-700 hover:text-white md:flex-none md:justify-center md:p-2 md:px-3',
                                {
